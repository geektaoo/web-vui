...
// This module is a runtime utility for cleaner components module output and will
...
function normalizeComponent (
  ...
  if (moduleIdentifier) { // server build
    hook = function (context) {
      ...
      // register components module identifier for async chunk inferrence
      if (context && context._registeredComponents) {
        context._registeredComponents.add(moduleIdentifier)
      }
    }
    // used by ssr in case components is cached and beforeCreate
    // never gets called
  ...
  if (hook) {
    if (options.functional) {
      ...
      // register for functioal components in vue file
      ...
      // inject components registration as beforeCreate hook
...
var buttonvue_type_template_id_76f05a9a_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{staticClass:"v-button",class:( _obj = {}, _obj[("icon-" + _vm.position)] = true, _obj ),on:{"click":function($event){_vm.$emit('click')}}},[(_vm.icon && !_vm.isLoading)?_c('v-icon',{staticClass:"icon",attrs:{"name":_vm.icon}}):_vm._e(),(_vm.isLoading)?_c('v-icon',{staticClass:"icon loading",attrs:{"name":"loading"}}):_vm._e(),_c('div',{staticClass:"v-content"},[_vm._t("default")],2)],1)
var _obj;}
...
input_component.options.__file = "input-demo.vue.vue"
